...
a.$config.scope.bodyUrl=a.$config.scope.$subnav.url+(0<=a.$config.scope.$subnav.url.indexOf("?")?"&":"?")+d.date.timestamp():console.error("wrong url or nav setting")},fullscreen:function(b){a.$config.scope.$fullscreen=d.valid.defined(b)?b:!0!==a.$config.scope.$fullscreen;a.$config.scope.$fullscreen?d.$("body").addClass("fullscreen"):d.$("body").removeClass("fullscreen")},$jsonp:function(e,f,g){c({method:"jsonp",url:e}).then(function(c){c.data.success?(f||b.noop)(c.data):"0001"===c.data.respCode?
d.ctrl.redirect(a.$config.host+a.$constant.uri.signOut):console.error(c.data)},function(a){console.error(a);(g||b.noop)(a.data)})}};return a}]).directive("layout",["$leo","$common",function(c,d){return{restrict:"E",replace:!0,transclude:!0,scope:!0,templateUrl:d.ctrl.scriptPath(["leo-api.min.js","leo-api.js"])+"/leo-api-layout.html",link:function(a,e,f){b.extend(a,{$init:function(){b.extend(a,{$host:f.host,$gateway:f.gateway,$accessToken:f.accessToken,$appId:f.appId,$brand:f.brand,$username:f.username,
$mode:parseInt(f.mode||0)});c.config(a.$host,a.gateway,a.$accessToken,a.$appId,a);a.$dom();a.$find({id:"_null",root:!0});c.apps(function(b){a.$apps=b})},$dom:function(){a.$transcludeDom=e.find("[ng-transclude]");a.$brandDom=a.$transcludeDom.find(".navbar-brand");a.$llisDom=a.$transcludeDom.find("li.layout-nav-left");a.$rlisDom=a.$transcludeDom.find("li.layout-nav-right");0<a.$brandDom.length&&(e.find(".navbar-header > .navbar-brand").remove(),e.find(".navbar-header").append(a.$brandDom));0<a.$llisDom.length&&
e.find(".navbar-nav").not(".navbar-right").append(a.$llisDom);0<a.$rlisDom.length&&e.find(".navbar-right").prepend(a.$rlisDom)},$find:function(b){a.$modes[a.$mode].$find(b)},$active:function(b){a.$subnav!==b&&(a.$subnav=b,c.refresh())},$modes:{0:{$find:function(b){d.valid.arr(b.children)&&!0===b.$loaded?(a.$nav=b,a.$active(a.$nav.children[0])):c.navs(b,function(c){d.valid.arr(c)?!0===b.root?(a.$navs=c,a.$modes[0].$find(a.$navs[0])):(a.$nav=b,a.$nav.$loaded=!0,a.$nav.children=c,a.$active(a.$nav.children[0])):
console.error(c)})}},1:{$find:function(e,f){d.valid.arr(e.children)&&!0===e.$loaded||c.navs(e,function(c){d.valid.arr(c)?!0===e.root?(a.$navs=c,b.forEach(a.$navs,function(b,c){a.$modes[1].$find(b,0===c)})):(e.children=c,e.$loaded=!0,f&&a.$active(e.children[0])):console.error(c)})}}}}).$init()}}}]).directive("view",["$leo",function(c){return{priority:0,restrict:"A",scope:!0,link:function(d,a,e){b.extend(d,{$init:function(){console.log("view log");d.$viewItemCodes=[];c.viewItems(e.view,function(a){b.forEach(a,
function(a){d.$viewItemCodes.push(a.code)})})}}).$init()}}}]).directive("viewItem",[function(){return{priority:10,restrict:"A",scope:!0,link:function(c,d,a){b.extend(c,{$init:function(){console.log(c);console.log(c.$viewItemCodes);console.log(a.viewItem)}}).$init()}}}])})(window.angular);
